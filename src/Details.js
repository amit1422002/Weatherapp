...
export default function Details(props) {
    ...
    const Data = ({ title, value }) => <View style={{ flexDirection: "row", justifyContent: 'space-between', alignItems: "center" }}>
        <Text style={{ color: 'gray', fontSize: 22 }} >{title}</Text>
        <Text style={{ color: 'white', fontSize: 22 }} >{value} </Text>
    </View>
    return (
        <View>
            <ImageBackground source={require('../assets/images/10.jpg')} style=
                    ...
                    data ? <View style={{ flexDirection: 'column', justifyContent: 'space-evenly', alignItems: 'center', height: DeviceHeight - 100 }}>
                       ...
                       <Text style={{ color: 'white', fontSize: 22,  marginBottom:16}} >Weather Details </Text>
                         <View style={{ width: DeviceWidth - 60 }}>
                            ...
                            <Data value={data['sys']['country']} title='Country' />
